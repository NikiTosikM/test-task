...
from src.app.schemas import OperatorSchema, OperatorPartialUpdateSchema, OperatorFullUpdateSchema
...
def create_operator(operator_data: OperatorSchema, session: GetSessionDep):
    ...
    operator_service.create_operator(data=operator_data)
...
def full_update_operator(
    operator_id: str,
    operator_data: OperatorFullUpdateSchema,
...
def partial_update_operator(
    operator_id: str,
    operator_data: OperatorPartialUpdateSchema,
    session: GetSessionDep
):
    operator_service = OperatorService(session=session)
    
    operator_service.update(data=operator_data, exclude_unset=True, id=UUID(operator_id))
